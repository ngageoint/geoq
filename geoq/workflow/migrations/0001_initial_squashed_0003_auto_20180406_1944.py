# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2018-04-17 23:50
...
class Migration(migrations.Migration):
    ...
    replaces = [(b'workflow', '0001_initial'), (b'workflow', '0002_auto_20180402_0819'), (b'workflow', '0003_auto_20180406_1944')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.ManyToManyField(blank=True, to=b'workflow.Role')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.ManyToManyField(blank=True, to=b'workflow.Role')),
                ('to_state', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transitions_into', to='workflow.State')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cloned_from', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='workflow.Workflow')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(help_text='The event relating to this happening in the workflow history', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='history', to='workflow.Event')),
                ('participant', models.ForeignKey(help_text='The participant who triggered this happening in the workflow history', on_delete=django.db.models.deletion.CASCADE, to='workflow.Participant')),
                ('state', models.ForeignKey(help_text='The state at this point in the workflow history', null=True, on_delete=django.db.models.deletion.CASCADE, to='workflow.State')),
                ('transition', models.ForeignKey(help_text='The transition relating to this happening in the workflow history', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='history', to='workflow.Transition')),
                ('workflowactivity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='history', to='workflow.WorkflowActivity')),
            ],
            options={
                'ordering': ['-created_on'],
        ...
        migrations.AddField(
            ...
            name='roles',
            field=models.ManyToManyField(blank=True, to=b'workflow.Role'),
        ),
        migrations.AddField(
            model_name='participant',
            name='user',
        ...
        migrations.AddField(
            model_name='participant',
            name='workflowactivity',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='participants', to='workflow.WorkflowActivity'),
        ),
        migrations.AddField(
            model_name='event',
            name='event_types',
            field=models.ManyToManyField(to=b'workflow.EventType'),
        ),
        migrations.AddField(
            model_name='event',
            name='roles',
            field=models.ManyToManyField(to=b'workflow.Role'),
        ),
        migrations.AddField(
            model_name='event',
            name='state',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='events', to='workflow.State'),
        ),
        migrations.AddField(
            model_name='event',
            name='workflow',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='events', to='workflow.Workflow'),
        ),
        migrations.AlterUniqueTogether(
            name='participant',
            unique_together=set([('user', 'workflowactivity')]),
        ),
        migrations.AddField(
            model_name='state',
            name='color',
            field=jsonfield.fields.JSONField(blank=True, help_text=b'Color properties for this state. Should be json that includes color, fillColor, fillOpacity, opacity and weight', null=True),
        ),
        migrations.AddField(
            model_name='state',
            name='slug',
