...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.disabled'
        db.add_column(u'maps_layer', 'disabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Layer.layer_info_link'
        db.add_column(u'maps_layer', 'layer_info_link',
    ...
    def backwards(self, orm):
        # Deleting field 'Layer.disabled'
        db.delete_column(u'maps_layer', 'disabled')

        # Deleting field 'Layer.layer_info_link'
        db.delete_column(u'maps_layer', 'layer_info_link')
