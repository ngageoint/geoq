...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Map', fields ['title']
        db.delete_unique(u'maps_map', ['title'])


    def backwards(self, orm):
        # Adding unique constraint on 'Map', fields ['title']
        db.create_unique(u'maps_map', ['title'])
