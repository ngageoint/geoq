...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EditableMapLayer'
        db.create_table(u'maps_editablemaplayer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=75)),
            ('view_url', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('edit_url', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal(u'maps', ['EditableMapLayer'])


    def backwards(self, orm):
        # Deleting model 'EditableMapLayer'
        db.delete_table(u'maps_editablemaplayer')
