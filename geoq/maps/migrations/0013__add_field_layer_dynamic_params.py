...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeatureType.icon'
        db.add_column(u'maps_layer', 'dynamic_params',
                      self.gf('jsonfield.JSONField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeatureType.icon'
        db.delete_column(u'maps_layer', 'dynamic_params')
    ...
    models = {
        ...
        u'maps.layer': {
            ...
            'dynamic_params': ('jsonfield.JSONField', [], {'null': 'True', 'blank': 'True'}),
