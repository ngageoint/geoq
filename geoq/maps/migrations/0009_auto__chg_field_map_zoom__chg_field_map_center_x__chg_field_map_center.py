...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Map.zoom'
        db.alter_column(u'maps_map', 'zoom', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Map.center_x'
        db.alter_column(u'maps_map', 'center_x', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Map.center_y'
        db.alter_column(u'maps_map', 'center_y', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Map.zoom'
        db.alter_column(u'maps_map', 'zoom', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Map.center_x'
        db.alter_column(u'maps_map', 'center_x', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Map.center_y'
        db.alter_column(u'maps_map', 'center_y', self.gf('django.db.models.fields.FloatField')())
