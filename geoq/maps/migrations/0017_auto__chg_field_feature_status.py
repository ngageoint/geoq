...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Feature.status'
        db.alter_column(u'maps_feature', 'status', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Feature.status'
        db.alter_column(u'maps_feature', 'status', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    models = {
        ...
        u'maps.feature': {
            ...
            'properties': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'In work'", 'max_length': '20'}),
