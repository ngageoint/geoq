...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeatureType.category'
        db.add_column(u'maps_featuretype', 'category',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeatureType.category'
        db.delete_column(u'maps_featuretype', 'category')
