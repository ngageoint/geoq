...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeatureType.order'
        db.add_column(u'maps_featuretype', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeatureType.order'
        db.delete_column(u'maps_featuretype', 'order')
    ...
    models = {
        ...
        u'maps.featuretype': {
            'Meta': {'ordering': "['-order', 'category', 'name', 'id']", 'object_name': 'FeatureType'},
