...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'maps_feature', 'status',
                      self.gf('django.db.models.fields.CharField')(default='Unassigned', max_length=15),
                      keep_default=False)


        # Changing field 'Layer.url'
        db.alter_column(u'maps_layer', 'url', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):
        # Deleting field 'Feature.status'
        db.delete_column(u'maps_feature', 'status')
