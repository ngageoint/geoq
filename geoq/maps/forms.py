...
class FeatureTypeForm(StyledModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            HTML('<tr><td class="key">Opacity</td><td><input type="text" class="value" id="opacity"></td></tr>'),
            HTML('<tr><td class="key">Weight</td><td><input type="text" class="value" id="weight"></td></tr>'),
