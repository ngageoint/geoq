...
DATABASES = {
    'default': {
        ...
        'USER': 'geoq',
        'PASSWORD': 'geoq',
        'HOST': '127.0.0.1',  # Empty for local through domain sockets or '127.0.0.1' for local through TCP.
...
STATIC_ROOT = '{0}{1}'.format('/home/omorrissey/www/static/', STATIC_URL_FOLDER)
