...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.openbadge_id'
        db.add_column(u'accounts_userprofile', 'openbadge_id',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.openbadge_id'
        db.delete_column(u'accounts_userprofile', 'openbadge_id')
    ...
    models = {
        ...
        u'accounts.userauthorization': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'permission_granted_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 10, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
