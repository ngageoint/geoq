...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AOI.assignee_type'
        db.add_column(u'core_aoi', 'assignee_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True),
                      keep_default=False)

        # Adding field 'AOI.assignee_id'
        db.add_column(u'core_aoi', 'assignee_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Job.assignee_type'
        db.add_column(u'core_job', 'assignee_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True),
                      keep_default=False)

        # Adding field 'Job.assignee_id'
        db.add_column(u'core_job', 'assignee_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AOI.assignee_type'
        db.delete_column(u'core_aoi', 'assignee_type_id')

        # Deleting field 'AOI.assignee_id'
        db.delete_column(u'core_aoi', 'assignee_id')

        # Deleting field 'Job.assignee_type'
        db.delete_column(u'core_job', 'assignee_type_id')

        # Deleting field 'Job.assignee_id'
        db.delete_column(u'core_job', 'assignee_id')
