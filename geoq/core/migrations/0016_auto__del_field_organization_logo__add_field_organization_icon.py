...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_organization', 'logo')

        # Adding field 'Organization.icon'
        db.add_column(u'core_organization', 'icon',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'core_organization', 'logo',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Organization.icon'
        db.delete_column(u'core_organization', 'icon')
