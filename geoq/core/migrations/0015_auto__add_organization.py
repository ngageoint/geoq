...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_organization', (
            ...
            ('url', self.gf('django.db.models.fields.CharField')(max_length=600, null=True, blank=True)),
            ('logo', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('show_on_front', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
