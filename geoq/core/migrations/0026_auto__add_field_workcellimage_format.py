...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkcellImage.format'
        db.add_column(u'core_workcellimage', 'format',
                      self.gf('django.db.models.fields.CharField')(default='OGC:WMS', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkcellImage.format'
        db.delete_column(u'core_workcellimage', 'format')
