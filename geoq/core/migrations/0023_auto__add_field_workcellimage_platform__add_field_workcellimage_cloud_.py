...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkcellImage.platform'
        db.add_column(u'core_workcellimage', 'platform',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'WorkcellImage.cloud_cover'
        db.add_column(u'core_workcellimage', 'cloud_cover',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkcellImage.platform'
        db.delete_column(u'core_workcellimage', 'platform')

        # Deleting field 'WorkcellImage.cloud_cover'
        db.delete_column(u'core_workcellimage', 'cloud_cover')
