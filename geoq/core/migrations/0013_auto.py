...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field teams on 'Job'
        m2m_table_name = db.shorten_name(u'core_job_teams')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('job', models.ForeignKey(orm[u'core.job'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['job_id', 'group_id'])


    def backwards(self, orm):
        # Removing M2M table for field teams on 'Job'
        db.delete_table(db.shorten_name(u'core_job_teams'))
