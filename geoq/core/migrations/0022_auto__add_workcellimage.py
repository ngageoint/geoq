...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WorkcellImage'
        db.create_table(u'core_workcellimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image_id', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('nef_name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('sensor', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('acq_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('img_geom', self.gf('django.contrib.gis.db.models.fields.GeometryField')(null=True, blank=True)),
            ('area', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=3)),
            ('status', self.gf('django.db.models.fields.CharField')(default='NotEvaluated', max_length=20)),
            ('workcell', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.AOI'])),
        ))
        db.send_create_signal(u'core', ['WorkcellImage'])


    def backwards(self, orm):
        # Deleting model 'WorkcellImage'
        db.delete_table(u'core_workcellimage')
    ...
    models = {
        ...
        u'core.workcellimage': {
            'Meta': {'ordering': "('-acq_date',)", 'object_name': 'WorkcellImage'},
            'acq_date': ('django.db.models.fields.DateTimeField', [], {}),
            'area': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_id': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'img_geom': ('django.contrib.gis.db.models.fields.GeometryField', [], {'null': 'True', 'blank': 'True'}),
            'nef_name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'sensor': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'NotEvaluated'", 'max_length': '20'}),
            'workcell': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.AOI']"})
        },
