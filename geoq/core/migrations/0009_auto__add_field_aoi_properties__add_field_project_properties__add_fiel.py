...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AOI.properties'
        db.add_column(u'core_aoi', 'properties',
                      self.gf('jsonfield.fields.JSONField')(null=True),
                      keep_default=False)

        # Adding field 'Project.properties'
        db.add_column(u'core_project', 'properties',
                      self.gf('jsonfield.fields.JSONField')(null=True),
                      keep_default=False)

        # Adding field 'Job.properties'
        db.add_column(u'core_job', 'properties',
                      self.gf('jsonfield.fields.JSONField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AOI.properties'
        db.delete_column(u'core_aoi', 'properties')

        # Deleting field 'Project.properties'
        db.delete_column(u'core_project', 'properties')

        # Deleting field 'Job.properties'
        db.delete_column(u'core_job', 'properties')
