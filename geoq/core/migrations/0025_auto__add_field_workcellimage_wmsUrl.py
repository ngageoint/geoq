...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkcellImage.wmsUrl'
        db.add_column(u'core_workcellimage', 'wmsUrl',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkcellImage.wmsUrl'
        db.delete_column(u'core_workcellimage', 'wmsUrl')
