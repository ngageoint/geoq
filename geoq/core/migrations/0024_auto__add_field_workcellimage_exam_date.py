...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkcellImage.exam_date'
        db.add_column(u'core_workcellimage', 'exam_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkcellImage.exam_date'
        db.delete_column(u'core_workcellimage', 'exam_date')
