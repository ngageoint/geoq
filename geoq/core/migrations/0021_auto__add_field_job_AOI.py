...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.AOI'
        db.add_column(u'core_job', 'AOI',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.AOI'
        db.delete_column(u'core_job', 'AOI')
    ...
    models = {
        ...
        u'core.job': {
            'AOI': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
