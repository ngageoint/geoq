...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AOI.finished_at'
        db.delete_column(u'core_aoi', 'finished_at')

        # Deleting field 'AOI.started_at'
        db.delete_column(u'core_aoi', 'started_at')

        # Adding field 'AOI.cellCreated_at'
        db.add_column(u'core_aoi', 'cellCreated_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AOI.cellAssigned_at'
        db.add_column(u'core_aoi', 'cellAssigned_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AOI.cellStarted_at'
        db.add_column(u'core_aoi', 'cellStarted_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AOI.cellWaitingReview_at'
        db.add_column(u'core_aoi', 'cellWaitingReview_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AOI.cellInReview_at'
        db.add_column(u'core_aoi', 'cellInReview_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AOI.cellFinished_at'
        db.add_column(u'core_aoi', 'cellFinished_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AOI.finished_at'
        db.add_column(u'core_aoi', 'finished_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AOI.started_at'
        db.add_column(u'core_aoi', 'started_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'AOI.cellCreated_at'
        db.delete_column(u'core_aoi', 'cellCreated_at')

        # Deleting field 'AOI.cellAssigned_at'
        db.delete_column(u'core_aoi', 'cellAssigned_at')

        # Deleting field 'AOI.cellStarted_at'
        db.delete_column(u'core_aoi', 'cellStarted_at')

        # Deleting field 'AOI.cellWaitingReview_at'
        db.delete_column(u'core_aoi', 'cellWaitingReview_at')

        # Deleting field 'AOI.cellInReview_at'
        db.delete_column(u'core_aoi', 'cellInReview_at')

        # Deleting field 'AOI.cellFinished_at'
        db.delete_column(u'core_aoi', 'cellFinished_at')
    ...
    models = {
        ...
        u'core.aoi': {
            ...
            'cellAssigned_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'cellCreated_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'cellFinished_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'cellInReview_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'cellStarted_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'cellWaitingReview_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
