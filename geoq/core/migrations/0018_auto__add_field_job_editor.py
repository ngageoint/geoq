...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.editor'
        db.add_column(u'core_job', 'editor',
                      self.gf('django.db.models.fields.CharField')(default=('geoq', 'geoq'), max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.editor'
        db.delete_column(u'core_job', 'editor')
