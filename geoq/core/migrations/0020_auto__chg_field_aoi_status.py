...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AOI.status'
        db.alter_column(u'core_aoi', 'status', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'AOI.status'
        db.alter_column(u'core_aoi', 'status', self.gf('django.db.models.fields.CharField')(max_length=15))
