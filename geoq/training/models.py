...
class Training(models.Model):
    ...
    content_link = models.URLField(max_length=500, help_text="Link to PDF/PPT/training or web page for training that will open in a new window", null=True, blank=True)
